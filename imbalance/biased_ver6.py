...
# 2. 랜덤 불균형 (Random Imbalance)
# 각 클래스마다 랜덤하게
np.random.seed(42)  # 재현성을 위해 시드 고정
class_ratios = {}
for i in range(10):
    class_ratios[i] = np.random.uniform(0.05, 1.0)
...
torch.save(model.state_dict(), 'models/mnist_biased_ver6.pth')
print("Model saved to models/mnist_biased_ver6.pth")
