...
# 2. 단계적 불균형 데이터 생성 (Gradual Imbalance)
# 숫자가 커질수록 점점 적어지게
class_ratios = {
    0: 1.0,   # 100%
    1: 0.9,   # 90%
...
torch.save(model.state_dict(), 'models/mnist_biased_ver2.pth')
print("Model saved to models/mnist_biased_ver2.pth")
